...
void ffc::LogFile(std::string  line) {
	/*std::ofstream file;
	file.open("C:\\Users\\Admin\\AppData\\Roaming\\MetaQuotes\\Terminal\\C6D03BEE984A8FF7763AA4060BA5C4AC\\MQL4\\Files\\log_Anderson.txt", std::ios::out | std::ios::app); //C:\\Users\\Admin\\AppData\\Roaming\\MetaQuotes\\Terminal\\C6D03BEE984A8FF7763AA4060BA5C4AC\\MQL4\\Experts
	if (file.fail())
